...
function readUInt64LE(buffer, pos, native){
	if(native === undefined) native = true;
	var long = Long.fromBits(buffer.readUInt32LE(pos), buffer.readUInt32LE(pos+4), true);
	if(!native) return long;
	return long.greaterThan(Long.MAX_UNSIGNED_VALUE)?long.toString(10):long.toNumber();
}

function writeUInt64LE(buffer, long, pos){
	if(!Long.isLong(long)){
		if("string" === typeof long){
			long = Long.fromString(long, true, 10);
		}else if("number" === typeof long)
			long = Long.fromNumber(long, true);
		else
			throw new Error("Unable to convert long to a Long");
	}
	buffer.writeUInt32LE(long.getLowBitsUnsigned(), pos);
	buffer.writeUInt32LE(long.getHighBitsUnsigned(), pos+4);
}
...
var MsgHdr = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.targetJobID || '18446744073709551615', 4);
    writeUInt64LE(buffer, object.sourceJobID || '18446744073709551615', 12);
  ...
  parse: function(buffer) {
    ...
    object.targetJobID = readUInt64LE(buffer, 4);
    object.sourceJobID = readUInt64LE(buffer, 12);
...
var ExtendedClientMsgHdr = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.targetJobID || '18446744073709551615', 7);
    writeUInt64LE(buffer, object.sourceJobID || '18446744073709551615', 15);
    buffer.writeUInt8(object.headerCanary || 239, 23);
    writeUInt64LE(buffer, object.steamID || 0, 24);
  ...
  parse: function(buffer) {
    ...
    object.targetJobID = readUInt64LE(buffer, 7);
    object.sourceJobID = readUInt64LE(buffer, 15);
    object.headerCanary = buffer.readUInt8(23);
    object.steamID = readUInt64LE(buffer, 24);
...
var MsgGCHdr = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.targetJobID || '18446744073709551615', 2);
    writeUInt64LE(buffer, object.sourceJobID || '18446744073709551615', 10);
  ...
  parse: function(buffer) {
    ...
    object.targetJobID = readUInt64LE(buffer, 2);
    object.sourceJobID = readUInt64LE(buffer, 10);
...
var MsgClientAppUsageEvent = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.gameID || 0, 4);
  ...
  parse: function(buffer) {
    ...
    object.gameID = readUInt64LE(buffer, 4);
...
var MsgClientP2PIntroducerMessage = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamID || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.steamID = readUInt64LE(buffer, 0);
...
var MsgClientOGSBeginSession = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.accountId || 0, 1);
  ...
  parse: function(buffer) {
    ...
    object.accountId = readUInt64LE(buffer, 1);
...
var MsgClientOGSBeginSessionResponse = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.sessionId || 0, 6);
  ...
  parse: function(buffer) {
    ...
    object.sessionId = readUInt64LE(buffer, 6);
...
var MsgClientOGSEndSession = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.sessionId || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.sessionId = readUInt64LE(buffer, 0);
...
var MsgClientGetFriendsWhoPlayGame = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.gameId || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.gameId = readUInt64LE(buffer, 0);
...
var MsgGSGetReputationResponse = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.bannedGameId || 0, 15);
  ...
  parse: function(buffer) {
    ...
    object.bannedGameId = readUInt64LE(buffer, 15);
...
var MsgGSGetUserGroupStatus = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdUser || 0, 0);
    writeUInt64LE(buffer, object.steamIdGroup || 0, 8);
  ...
  parse: function(buffer) {
    ...
    object.steamIdUser = readUInt64LE(buffer, 0);
    object.steamIdGroup = readUInt64LE(buffer, 8);
...
var MsgClientJoinChat = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdChat || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.steamIdChat = readUInt64LE(buffer, 0);
...
var MsgClientChatEnter = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdChat || 0, 0);
    writeUInt64LE(buffer, object.steamIdFriend || 0, 8);
    buffer.writeInt32LE(object.chatRoomType || 0, 16);
    writeUInt64LE(buffer, object.steamIdOwner || 0, 20);
    writeUInt64LE(buffer, object.steamIdClan || 0, 28);
  ...
  parse: function(buffer) {
    ...
    object.steamIdChat = readUInt64LE(buffer, 0);
    object.steamIdFriend = readUInt64LE(buffer, 8);
    object.chatRoomType = buffer.readInt32LE(16);
    object.steamIdOwner = readUInt64LE(buffer, 20);
    object.steamIdClan = readUInt64LE(buffer, 28);
...
var MsgClientChatMsg = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdChatter || 0, 0);
    writeUInt64LE(buffer, object.steamIdChatRoom || 0, 8);
  ...
  parse: function(buffer) {
    ...
    object.steamIdChatter = readUInt64LE(buffer, 0);
    object.steamIdChatRoom = readUInt64LE(buffer, 8);
...
var MsgClientChatAction = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdChat || 0, 0);
    writeUInt64LE(buffer, object.steamIdUserToActOn || 0, 8);
  ...
  parse: function(buffer) {
    ...
    object.steamIdChat = readUInt64LE(buffer, 0);
    object.steamIdUserToActOn = readUInt64LE(buffer, 8);
...
var MsgClientChatActionResult = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.steamIdChat || 0, 0);
    writeUInt64LE(buffer, object.steamIdUserActedOn || 0, 8);
    buffer.writeInt32LE(object.chatAction || 0, 16);
  ...
  parse: function(buffer) {
    ...
    object.steamIdChat = readUInt64LE(buffer, 0);
    object.steamIdUserActedOn = readUInt64LE(buffer, 8);
    object.chatAction = buffer.readInt32LE(16);
...
var MsgClientSetIgnoreFriend = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.mySteamId || 0, 0);
    writeUInt64LE(buffer, object.steamIdFriend || 0, 8);
  ...
  parse: function(buffer) {
    ...
    object.mySteamId = readUInt64LE(buffer, 0);
    object.steamIdFriend = readUInt64LE(buffer, 8);
...
var MsgClientSetIgnoreFriendResponse = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.unknown || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.unknown = readUInt64LE(buffer, 0);
...
var MsgClientLogOnResponse = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.clientSuppliedSteamId || 0, 12);
  ...
  parse: function(buffer) {
    ...
    object.clientSuppliedSteamId = readUInt64LE(buffer, 12);
...
var MsgClientSendGuestPass = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.giftId || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.giftId = readUInt64LE(buffer, 0);
...
var MsgClientServerUnavailable = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.jobidSent || 0, 0);
  ...
  parse: function(buffer) {
    ...
    object.jobidSent = readUInt64LE(buffer, 0);
...
var MsgClientCreateChat = {
  ...
  serialize: function(object) {
    ...
    writeUInt64LE(buffer, object.gameId || 0, 4);
    writeUInt64LE(buffer, object.steamIdClan || 0, 12);
    ...
    buffer.writeUInt8(object.chatFlags || 0, 36);
    writeUInt64LE(buffer, object.steamIdFriendChat || 0, 37);
    writeUInt64LE(buffer, object.steamIdInvited || 0, 45);
  ...
  parse: function(buffer) {
    ...
    object.gameId = readUInt64LE(buffer, 4);
    object.steamIdClan = readUInt64LE(buffer, 12);
    ...
    object.chatFlags = buffer.readUInt8(36);
    object.steamIdFriendChat = readUInt64LE(buffer, 37);
    object.steamIdInvited = readUInt64LE(buffer, 45);
...
var MsgClientCreateChatResponse = {
  ...
  serialize: function(object) {
    ...
    buffer.writeInt32LE(object.result || 0, 0);
    writeUInt64LE(buffer, object.steamIdChat || 0, 4);
    buffer.writeInt32LE(object.chatRoomType || 0, 12);
    writeUInt64LE(buffer, object.steamIdFriendChat || 0, 16);
  ...
  parse: function(buffer) {
    ...
    object.result = buffer.readInt32LE(0);
    object.steamIdChat = readUInt64LE(buffer, 4);
    object.chatRoomType = buffer.readInt32LE(12);
    object.steamIdFriendChat = readUInt64LE(buffer, 16);
